...
---------|------|-------------|---------|--------|--------|---
1486500|1024|5m0s|11.899|0.927|36.539|10.664
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.000000000000000078EDB9D1FD8F56AC|0|1486499|0|1486500|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-kqrxjexg_collector-*/*/*.log", "/var/log/pods/testhack-kqrxjexg_elasticsearch-*/*/*.log", "/var/log/pods/testhack-kqrxjexg_*/loki*/*.log", "/var/log/pods/testhack-kqrxjexg_kibana-*/*/*.log", "/var/log/pods/testhack-kqrxjexg_*/gateway/*.log", "/var/log/pods/testhack-kqrxjexg_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-kqrxjexg"'
