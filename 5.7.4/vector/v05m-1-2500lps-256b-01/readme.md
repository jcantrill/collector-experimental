...
---------|------|-------------|---------|--------|--------|---
756232|256|5m0s|2.869|0.097|17.854|0.852
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.000000000000000094FF4869208F3251|0|756231|0|756232|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-c2w3634o_collector-*/*/*.log", "/var/log/pods/testhack-c2w3634o_elasticsearch-*/*/*.log", "/var/log/pods/testhack-c2w3634o_*/loki*/*.log", "/var/log/pods/testhack-c2w3634o_kibana-*/*/*.log", "/var/log/pods/testhack-c2w3634o_*/gateway/*.log", "/var/log/pods/testhack-c2w3634o_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-c2w3634o"'
