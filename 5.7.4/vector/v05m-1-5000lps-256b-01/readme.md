...
---------|------|-------------|---------|--------|--------|---
1520104|256|5m0s|5.272|0.201|18.683|4.138
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000F33DFEBEAEDC0F5A|0|1520103|0|1520104|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-ehctbsfm_collector-*/*/*.log", "/var/log/pods/testhack-ehctbsfm_elasticsearch-*/*/*.log", "/var/log/pods/testhack-ehctbsfm_*/loki*/*.log", "/var/log/pods/testhack-ehctbsfm_kibana-*/*/*.log", "/var/log/pods/testhack-ehctbsfm_*/gateway/*.log", "/var/log/pods/testhack-ehctbsfm_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-ehctbsfm"'
