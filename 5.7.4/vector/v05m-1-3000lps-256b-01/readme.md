...
---------|------|-------------|---------|--------|--------|---
911400|256|5m0s|3.314|0.098|18.864|0.969
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000B8D45760B6B5909D|0|911399|0|911400|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-d5dgk6qq_collector-*/*/*.log", "/var/log/pods/testhack-d5dgk6qq_elasticsearch-*/*/*.log", "/var/log/pods/testhack-d5dgk6qq_*/loki*/*.log", "/var/log/pods/testhack-d5dgk6qq_kibana-*/*/*.log", "/var/log/pods/testhack-d5dgk6qq_*/gateway/*.log", "/var/log/pods/testhack-d5dgk6qq_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-d5dgk6qq"'
