...
---------|------|-------------|---------|--------|--------|---
1152963|1024|5m0s|7.816|0.157|34.988|6.586
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.00000000000000001F9F3EBC257E6462|0|1152962|0|1152963|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-f6wy27jf_collector-*/*/*.log", "/var/log/pods/testhack-f6wy27jf_elasticsearch-*/*/*.log", "/var/log/pods/testhack-f6wy27jf_*/loki*/*.log", "/var/log/pods/testhack-f6wy27jf_kibana-*/*/*.log", "/var/log/pods/testhack-f6wy27jf_*/gateway/*.log", "/var/log/pods/testhack-f6wy27jf_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-f6wy27jf"'
