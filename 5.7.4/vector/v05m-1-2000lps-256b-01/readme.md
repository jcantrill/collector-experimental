...
---------|------|-------------|---------|--------|--------|---
581677|256|5m0s|1.870|0.068|17.645|0.734
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.00000000000000002973CC67B77DC781|0|581676|0|581677|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-csxamu6x_collector-*/*/*.log", "/var/log/pods/testhack-csxamu6x_elasticsearch-*/*/*.log", "/var/log/pods/testhack-csxamu6x_*/loki*/*.log", "/var/log/pods/testhack-csxamu6x_kibana-*/*/*.log", "/var/log/pods/testhack-csxamu6x_*/gateway/*.log", "/var/log/pods/testhack-csxamu6x_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-csxamu6x"'
