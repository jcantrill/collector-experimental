...
---------|------|-------------|---------|--------|--------|---
1587948|256|5m0s|18.665|4.407|36.472|16.420
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000C422D901227FED03|0|1776347|0|1587948|89.4%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-fxqllxyh_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-fxqllxyh_collector-*/*/*.log", "/var/log/pods/testhack-fxqllxyh_elasticsearch-*/*/*.log", "/var/log/pods/testhack-fxqllxyh_kibana-*/*/*.log", "/var/log/pods/testhack-fxqllxyh_*/loki*/*.log", "/var/log/pods/testhack-fxqllxyh_*/gateway/*.log", "/var/log/pods/testhack-fxqllxyh_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
