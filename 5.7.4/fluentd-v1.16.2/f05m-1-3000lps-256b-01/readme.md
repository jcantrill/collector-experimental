...
---------|------|-------------|---------|--------|--------|---
953201|256|5m0s|1.079|0.088|9.565|0.744
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.00000000000000008FEC6B54173CFDDA|0|953200|0|953201|100.0%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-coexfcbq_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-coexfcbq_collector-*/*/*.log", "/var/log/pods/testhack-coexfcbq_elasticsearch-*/*/*.log", "/var/log/pods/testhack-coexfcbq_kibana-*/*/*.log", "/var/log/pods/testhack-coexfcbq_*/loki*/*.log", "/var/log/pods/testhack-coexfcbq_*/gateway/*.log", "/var/log/pods/testhack-coexfcbq_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
