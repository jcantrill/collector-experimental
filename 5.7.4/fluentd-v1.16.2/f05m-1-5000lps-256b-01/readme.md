...
---------|------|-------------|---------|--------|--------|---
1552500|256|5m0s|3.403|0.186|8.818|3.117
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.00000000000000004F0F8D62F8599C3A|0|1552499|0|1552500|100.0%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-fheq6dgd_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-fheq6dgd_collector-*/*/*.log", "/var/log/pods/testhack-fheq6dgd_elasticsearch-*/*/*.log", "/var/log/pods/testhack-fheq6dgd_kibana-*/*/*.log", "/var/log/pods/testhack-fheq6dgd_*/loki*/*.log", "/var/log/pods/testhack-fheq6dgd_*/gateway/*.log", "/var/log/pods/testhack-fheq6dgd_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
