...
---------|------|-------------|---------|--------|--------|---
865777|1024|5m0s|15.709|0.736|23.882|16.021
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000F4C35CCEF1A4EEDC|0|930921|0|865777|93.0%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-gzdy4chx_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-gzdy4chx_collector-*/*/*.log", "/var/log/pods/testhack-gzdy4chx_elasticsearch-*/*/*.log", "/var/log/pods/testhack-gzdy4chx_kibana-*/*/*.log", "/var/log/pods/testhack-gzdy4chx_*/loki*/*.log", "/var/log/pods/testhack-gzdy4chx_*/gateway/*.log", "/var/log/pods/testhack-gzdy4chx_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
