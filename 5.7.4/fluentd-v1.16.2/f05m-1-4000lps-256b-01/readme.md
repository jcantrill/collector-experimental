...
---------|------|-------------|---------|--------|--------|---
1245139|256|5m0s|1.389|0.128|8.312|0.888
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000583C104B4FFC6CBB|0|1245138|0|1245139|100.0%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-ehml3ija_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-ehml3ija_collector-*/*/*.log", "/var/log/pods/testhack-ehml3ija_elasticsearch-*/*/*.log", "/var/log/pods/testhack-ehml3ija_kibana-*/*/*.log", "/var/log/pods/testhack-ehml3ija_*/loki*/*.log", "/var/log/pods/testhack-ehml3ija_*/gateway/*.log", "/var/log/pods/testhack-ehml3ija_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
