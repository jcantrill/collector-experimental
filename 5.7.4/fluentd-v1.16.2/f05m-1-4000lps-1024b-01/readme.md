...
---------|------|-------------|---------|--------|--------|---
861425|1024|5m0s|15.447|0.507|29.152|15.434
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.000000000000000039F7CC9932056F1D|0|1135106|0|861425|75.9%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-gie7dfxg_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-gie7dfxg_collector-*/*/*.log", "/var/log/pods/testhack-gie7dfxg_elasticsearch-*/*/*.log", "/var/log/pods/testhack-gie7dfxg_kibana-*/*/*.log", "/var/log/pods/testhack-gie7dfxg_*/loki*/*.log", "/var/log/pods/testhack-gie7dfxg_*/gateway/*.log", "/var/log/pods/testhack-gie7dfxg_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
