...
---------|------|-------------|---------|--------|--------|---
1069708|256|5m0s|20.003|1.357|38.673|19.953
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000BD50388AC3827297|0|1385707|0|1069708|77.2%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-etvi4xn5_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-etvi4xn5_collector-*/*/*.log", "/var/log/pods/testhack-etvi4xn5_elasticsearch-*/*/*.log", "/var/log/pods/testhack-etvi4xn5_kibana-*/*/*.log", "/var/log/pods/testhack-etvi4xn5_*/loki*/*.log", "/var/log/pods/testhack-etvi4xn5_*/gateway/*.log", "/var/log/pods/testhack-etvi4xn5_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
