...
---------|------|-------------|---------|--------|--------|---
615339|256|5m0s|1.009|0.101|10.641|0.731
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000171AD78694AD71AC|0|615338|0|615339|100.0%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-cggaqjsq_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-cggaqjsq_collector-*/*/*.log", "/var/log/pods/testhack-cggaqjsq_elasticsearch-*/*/*.log", "/var/log/pods/testhack-cggaqjsq_kibana-*/*/*.log", "/var/log/pods/testhack-cggaqjsq_*/loki*/*.log", "/var/log/pods/testhack-cggaqjsq_*/gateway/*.log", "/var/log/pods/testhack-cggaqjsq_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
