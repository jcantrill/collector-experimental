...
---------|------|-------------|---------|--------|--------|---
768000|256|5m0s|1.430|0.132|9.693|0.864
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.000000000000000008CD2248CE07FD7A|0|767999|0|768000|100.0%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-dj5p2ggz_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-dj5p2ggz_collector-*/*/*.log", "/var/log/pods/testhack-dj5p2ggz_elasticsearch-*/*/*.log", "/var/log/pods/testhack-dj5p2ggz_kibana-*/*/*.log", "/var/log/pods/testhack-dj5p2ggz_*/loki*/*.log", "/var/log/pods/testhack-dj5p2ggz_*/gateway/*.log", "/var/log/pods/testhack-dj5p2ggz_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
