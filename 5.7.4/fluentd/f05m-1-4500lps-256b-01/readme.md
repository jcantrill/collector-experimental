...
---------|------|-------------|---------|--------|--------|---
1077245|256|5m0s|25.301|6.607|49.560|22.759
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.00000000000000001C6C5BCB3CBC9BC2|0|1266244|0|1077245|85.1%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-fs6ntmbk_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-fs6ntmbk_collector-*/*/*.log", "/var/log/pods/testhack-fs6ntmbk_elasticsearch-*/*/*.log", "/var/log/pods/testhack-fs6ntmbk_kibana-*/*/*.log", "/var/log/pods/testhack-fs6ntmbk_*/loki*/*.log", "/var/log/pods/testhack-fs6ntmbk_*/gateway/*.log", "/var/log/pods/testhack-fs6ntmbk_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
