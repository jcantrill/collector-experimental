...
---------|------|-------------|---------|--------|--------|---
520330|1024|5m0s|22.992|1.132|49.407|22.559
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000B60945194C09CE0C|0|1085681|0|520330|47.9%
...
<source>
  @type tail
  @id container-input
  path "/var/log/pods/testhack-jth337ub_*/loader-*/*.log"
  exclude_path ["/var/log/pods/testhack-jth337ub_collector-*/*/*.log", "/var/log/pods/testhack-jth337ub_elasticsearch-*/*/*.log", "/var/log/pods/testhack-jth337ub_kibana-*/*/*.log", "/var/log/pods/testhack-jth337ub_*/loki*/*.log", "/var/log/pods/testhack-jth337ub_*/gateway/*.log", "/var/log/pods/testhack-jth337ub_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
