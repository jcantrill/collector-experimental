...
---------|------|-------------|---------|--------|--------|---
619037|1024|5m0s|4.659|0.215|17.243|2.033
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|0|1332598|0|619037|46.5%
...
data_dir = "/var/lib/vector/testhack-e74i6ngt/instance"
...
include_paths_glob_patterns = ["/var/log/pods/testhack-e74i6ngt_*/*/*.log"]
