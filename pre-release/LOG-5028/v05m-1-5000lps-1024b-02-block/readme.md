...
---------|------|-------------|---------|--------|--------|---
1201201|1024|5m0s|4.512|0.253|13.140|3.724
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|75000|1529245|0|1201201|82.6%
...
data_dir = "/var/lib/vector/testhack-foczjsba/instance"
...
include_paths_glob_patterns = ["/var/log/pods/testhack-foczjsba_*/*/*.log"]
