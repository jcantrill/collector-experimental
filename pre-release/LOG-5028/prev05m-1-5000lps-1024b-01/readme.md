...
---------|------|-------------|---------|--------|--------|---
727333|1024|5m0s|4.368|0.308|12.776|3.329
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|70000|1503009|0|727333|50.8%
...
data_dir = "/var/lib/vector/testhack-hwwepr5f/instance"
...
include_paths_glob_patterns = ["/var/log/pods/testhack-hwwepr5f_*/*/*.log"]
