...
---------|------|-------------|---------|--------|--------|---
1228232|1024|5m0s|5.581|0.247|17.687|5.046
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|0|1418854|0|1228232|86.6%
...
data_dir = "/var/lib/vector/testhack-hhkccok3/instance"
...
include_paths_glob_patterns = ["/var/log/pods/testhack-hhkccok3_*/*/*.log"]
