...
---------|------|-------------|---------|--------|--------|---
2710382|256|5m0s|27.996|0.378|68.484|8.585
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|0|1480381|0|2710382|183.1%
...
data_dir = "/var/lib/vector/testhack-hmquinwa/instance"
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-hmquinwa"'
