...
---------|------|-------------|---------|--------|--------|---
1546543|256|5m0s|2.985|0.279|17.178|1.412
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0000000000000000A90A8EA820F5E15E|0|1546542|0|1546543|100.0%
...
data_dir = "/var/lib/vector/testhack-i4bbira7/instance"
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-i4bbira7_logfilesmetricexporter-*/*/*.log", "/var/log/pods/testhack-i4bbira7_elasticsearch-*/*/*.log", "/var/log/pods/testhack-i4bbira7_*/loki*/*.log", "/var/log/pods/testhack-i4bbira7_kibana-*/*/*.log", "/var/log/pods/testhack-i4bbira7_*/gateway/*.log", "/var/log/pods/testhack-i4bbira7_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-i4bbira7"'
