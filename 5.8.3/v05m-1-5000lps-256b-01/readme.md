...
---------|------|-------------|---------|--------|--------|---
1770478|256|5m0s|33.991|0.504|82.790|11.875
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|0|1518891|0|1770478|116.6%
...
data_dir = "/var/lib/vector/testhack-haesmfjs/instance"
...
exclude_paths_glob_patterns = ["/var/log/pods/*/collector/*.log","/var/log/pods/*/http/*.log"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-haesmfjs"'
