...
---------|------|-------------|---------|--------|--------|---
302900|256|5m0s|1.534|0.044|17.852|0.670
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.0000000000000000CE8145EFB4DD03EF|0|302899|0|302900|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-l4kqvivv_collector-*/*/*.log", "/var/log/pods/testhack-l4kqvivv_elasticsearch-*/*/*.log", "/var/log/pods/testhack-l4kqvivv_*/loki*/*.log", "/var/log/pods/testhack-l4kqvivv_kibana-*/*/*.log", "/var/log/pods/testhack-l4kqvivv_*/gateway/*.log", "/var/log/pods/testhack-l4kqvivv_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
