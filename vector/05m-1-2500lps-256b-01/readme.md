...
---------|------|-------------|---------|--------|--------|---
758500|256|5m0s|2.375|0.088|17.776|0.810
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.000000000000000029E63FC7A6816A2D|0|758499|0|758500|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-mvs3lf44_collector-*/*/*.log", "/var/log/pods/testhack-mvs3lf44_elasticsearch-*/*/*.log", "/var/log/pods/testhack-mvs3lf44_*/loki*/*.log", "/var/log/pods/testhack-mvs3lf44_kibana-*/*/*.log", "/var/log/pods/testhack-mvs3lf44_*/gateway/*.log", "/var/log/pods/testhack-mvs3lf44_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
