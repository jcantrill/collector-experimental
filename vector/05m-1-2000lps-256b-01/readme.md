...
---------|------|-------------|---------|--------|--------|---
602005|256|5m0s|1.905|0.081|17.973|0.731
...
-------| ---------| --------| -------|-----------|--------------|
| functional.0.000000000000000048BF8768C904762D|0|602004|0|602005|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-mm2bzb2d_collector-*/*/*.log", "/var/log/pods/testhack-mm2bzb2d_elasticsearch-*/*/*.log", "/var/log/pods/testhack-mm2bzb2d_*/loki*/*.log", "/var/log/pods/testhack-mm2bzb2d_kibana-*/*/*.log", "/var/log/pods/testhack-mm2bzb2d_*/gateway/*.log", "/var/log/pods/testhack-mm2bzb2d_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
