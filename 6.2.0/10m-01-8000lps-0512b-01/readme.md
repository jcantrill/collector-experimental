...
---------|------|-------------|---------|--------|--------|---
4360356|512|10m0s|3.911|0.195|18.445|1.649
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|0|4773136|0|4360356|91.4%
...
data_dir = "/var/lib/vector/testhack-dq4unev7/functional"
...
include_paths_glob_patterns = ["/var/log/pods/testhack-dq4unev7_*/*/*.log"]
