...
---------|------|-------------|---------|--------|--------|---
4158583|512|10m0s|5.648|0.248|19.176|3.899
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|0|4839999|0|4158583|85.9%
...
data_dir = "/var/lib/vector/testhack-eismkcry/functional"
...
include_paths_glob_patterns = ["/var/log/pods/testhack-eismkcry_*/*/*.log"]
