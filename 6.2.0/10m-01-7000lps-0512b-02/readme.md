...
---------|------|-------------|---------|--------|--------|---
4150387|512|10m0s|5.506|0.264|19.670|4.468
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|0|4154794|0|4150387|99.9%
...
data_dir = "/var/lib/vector/testhack-c5dp5ohx/functional"
...
include_paths_glob_patterns = ["/var/log/pods/testhack-c5dp5ohx_*/*/*.log"]
