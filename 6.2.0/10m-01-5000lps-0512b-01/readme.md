...
---------|------|-------------|---------|--------|--------|---
3038451|512|10m0s|4.421|0.234|17.542|2.062
...
-------| ---------| --------| -------|-----------|--------------|
| loader-0|0|3038450|0|3038451|100.0%
...
data_dir = "/var/lib/vector/testhack-rby47drg/functional"
...
include_paths_glob_patterns = ["/var/log/pods/testhack-rby47drg_*/*/*.log"]
