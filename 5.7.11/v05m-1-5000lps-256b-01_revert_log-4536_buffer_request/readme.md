...
## Options
* Image: quay.io/jcantril/vector:release-5.7.11
...
---------|------|-------------|---------|--------|--------|---
1540930|256|5m0s|4.605|0.407|17.608|1.698
...
-------| ---------| --------| -------|-----------|--------------|
| functional.000000000000000078637E06A686518A|0|1540929|0|1540930|100.0%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-oiw7zop2_collector-*/*/*.log", "/var/log/pods/testhack-oiw7zop2_elasticsearch-*/*/*.log", "/var/log/pods/testhack-oiw7zop2_*/loki*/*.log", "/var/log/pods/testhack-oiw7zop2_kibana-*/*/*.log", "/var/log/pods/testhack-oiw7zop2_*/gateway/*.log", "/var/log/pods/testhack-oiw7zop2_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-oiw7zop2"'
