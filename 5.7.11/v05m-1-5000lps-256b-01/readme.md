...
---------|------|-------------|---------|--------|--------|---
970513|256|5m0s|3.200|0.403|15.680|1.547
...
-------| ---------| --------| -------|-----------|--------------|
| functional.000000000000000069F1AAAAE73ED6B5|0|1529053|0|970513|63.5%
...
exclude_paths_glob_patterns = ["/var/log/pods/testhack-n2vjujnh_collector-*/*/*.log", "/var/log/pods/testhack-n2vjujnh_elasticsearch-*/*/*.log", "/var/log/pods/testhack-n2vjujnh_*/loki*/*.log", "/var/log/pods/testhack-n2vjujnh_kibana-*/*/*.log", "/var/log/pods/testhack-n2vjujnh_*/gateway/*.log", "/var/log/pods/testhack-n2vjujnh_*/opa/*.log", "/var/log/pods/*/*/*.gz", "/var/log/pods/*/*/*.tmp"]
...
type = "route"
inputs = ["application"]
route.benchmark = '.kubernetes.namespace_name == "testhack-n2vjujnh"'
